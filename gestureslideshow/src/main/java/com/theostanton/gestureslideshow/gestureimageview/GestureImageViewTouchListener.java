...
//    private Logger log = new Logger(this);
    ...
    public boolean canScrollX(int nextX) {
//        log("nextX=" + nextX + "\tl.x=" + last.x + "\tbl=" + boundaryLeft + "\tbr=" + boundaryRight);
        boolean l = nextX < boundaryLeft;
        boolean r = nextX > boundaryRight;
//		log("l=" + l + "\tr=" + r);
        return l || r;
    }
